from strategist import WordleStrategist, OccurrenceWordleStrategist, RandomWordleStrategist, MixedWordleStrategist
...
for word in answer_word_list:
    ...
    for i in range(7):
        ...
        if i ==0:
            black_char, black_id, yellow_char, yellow_id, green_char, green_id = answer.attempt_word(a[0])
        else:
        ...
        if green_id == [0,1,2,3,4]: #answer.word == a[0][0]
            print('Win: with {0:2d} attempt(s)!'.format(i))
...
print( 'total number of answer word list is ', len(answer_word_list))
# no answer word list.  
# 
